...
export function HomeWorkoutTab({ activeDay, setActiveDay }: { activeDay: string, setActiveDay: (day: string) => void }) {
    const { currentStudent, markExerciseComplete, isLoading: storeLoading } = useWorkoutStore();
        ...
        <div className="space-y-6">
            ...
            <GlassCard variant="strong" glow className="relative overflow-hidden p-6 rounded-3xl">
                ...
                <div className="relative">
                    ...
                    <p className="text-sm text-muted-foreground mb-6">Foco total, {currentStudent?.name.split(' ')[0] || 'Atleta'}!</p>
